...
import '/customer_user/container_makanan/container_makanan_widget.dart';
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<List<OutletsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<OutletsRecord> gridViewOutletsRecordList =
                                  snapshot.data!;
                              ...
                              return GridView.builder(
                                ...
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: gridViewOutletsRecordList.length,
                                itemBuilder: (context, gridViewIndex) {
                                  final gridViewOutletsRecord =
                                      gridViewOutletsRecordList[gridViewIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    hoverColor: Colors.transparent,
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'id': serializeParam(
                                            gridViewOutletsRecord.reference,
                                    ...
                                    child: ContainerOutletWidget(
                                      ...
                                      parameter2: gridViewOutletsRecord.name,
                                    ),
                                  );
                                },
                              );
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(18.0, 0.0,
                                                                18.0, 0.0),
                                                    child:
                                                        ContainerMakananWidget(
                                                      key: Key(
                                                          'Key7po_${columnIndex}_of_${columnPackagesRecordList.length}'),
                                                      parameter1:
