...
import 'confirm_setuju_outlet_model.dart';
export 'confirm_setuju_outlet_model.dart';
...
class ConfirmSetujuOutletWidget extends StatefulWidget {
  const ConfirmSetujuOutletWidget({super.key});

  @override
  State<ConfirmSetujuOutletWidget> createState() =>
      _ConfirmSetujuOutletWidgetState();
}

class _ConfirmSetujuOutletWidgetState extends State<ConfirmSetujuOutletWidget> {
  late ConfirmSetujuOutletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmSetujuOutletModel());
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Apakah anda ingin menyetujui outlet ini?',
                  ...
                  Text(
                    'Setelah outlet disetujui, tindakan ini tidak dapat dibatalkan.',
                    textAlign: TextAlign.center,
