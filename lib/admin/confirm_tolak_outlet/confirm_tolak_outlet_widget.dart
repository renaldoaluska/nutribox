...
import 'confirm_tolak_outlet_model.dart';
export 'confirm_tolak_outlet_model.dart';
...
class ConfirmTolakOutletWidget extends StatefulWidget {
  const ConfirmTolakOutletWidget({super.key});

  @override
  State<ConfirmTolakOutletWidget> createState() =>
      _ConfirmTolakOutletWidgetState();
}

class _ConfirmTolakOutletWidgetState extends State<ConfirmTolakOutletWidget> {
  late ConfirmTolakOutletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmTolakOutletModel());
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'Apakah anda ingin menolak outlet ini?',
                  ...
                  Text(
                    'Setelah outlet ditolak, tindakan ini tidak dapat dibatalkan.',
                    textAlign: TextAlign.center,
