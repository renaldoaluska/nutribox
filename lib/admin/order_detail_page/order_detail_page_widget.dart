...
class OrderDetailPageWidget extends StatefulWidget {
  ...
  final DocumentReference? orderDetail;

  static String routeName = 'Order_detail_page';
...
class _OrderDetailPageWidgetState extends State<OrderDetailPageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<OrdersRecord>(
      stream: OrdersRecord.getDocument(widget.orderDetail!),
      builder: (context, snapshot) {
        ...
        final orderDetailPageOrdersRecord = snapshot.data!;
                          ...
                          children: [
                            ...
                            StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(
                                  orderDetailPageOrdersRecord.customerRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            '${columnAddressesRecord.address.toMap().toString()}',
                                                            maxLines: 3,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                            ...
                            StreamBuilder<OutletsRecord>(
                              stream: OutletsRecord.getDocument(
                                  orderDetailPageOrdersRecord.outletRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                ...
                                final containerOutletsRecord = snapshot.data!;
                                    ...
                                    StreamBuilder<List<OrderItemRecord>>(
                                      stream: queryOrderItemRecord(
                                        queryBuilder: (orderItemRecord) =>
                                          ...
                                          'order_ref',
                                          isEqualTo: orderDetailPageOrdersRecord
                                              .reference,
                                        ),
                                      ),
                                      builder: (context, snapshot) {
                                        ...
                                        return Column(
                                          ...
                                          children: List.generate(
                                              columnOrderItemRecordList.length,
                                              (columnIndex) {
                                                ...
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        '${columnOrderItemRecord.quantity.toString()}x ${columnOrderItemRecord.pricePerUnit.toString()}',
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodySmall
                                                            .override(
