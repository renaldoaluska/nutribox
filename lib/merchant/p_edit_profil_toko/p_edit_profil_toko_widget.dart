...
import 'p_edit_profil_toko_model.dart';
export 'p_edit_profil_toko_model.dart';
...
class PEditProfilTokoWidget extends StatefulWidget {
  const PEditProfilTokoWidget({
    super.key,
    this.profilSaya,
  });
  ...
  static String routeName = 'P_Edit_Profil_Toko';
  static String routePath = '/outlet/EditProfilToko';

  @override
  State<PEditProfilTokoWidget> createState() => _PEditProfilTokoWidgetState();
}

class _PEditProfilTokoWidgetState extends State<PEditProfilTokoWidget> {
  late PEditProfilTokoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PEditProfilTokoModel());
                        ...
                        Expanded(
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.pushNamed(PProfileTokoWidget.routeName);
                            },
                            text: 'Simpan',
                            options: FFButtonOptions(
                              height: 48.0,
